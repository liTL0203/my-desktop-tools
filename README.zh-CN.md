...
| 版本 | 平台 | 下载 |
|------|------|------|
| v0.36.1 | Windows 10 及以上（64 位） | [MSI 安装包（英文）](https://github.com/liTL0203/my-desktop-tools/releases/download/v0.36.1/My.Desktop.Tools_0.36.1_x64_en-US.msi) · [MSI 安装包（中文）](https://github.com/liTL0203/my-desktop-tools/releases/download/v0.36.1/My.Desktop.Tools_0.36.1_x64_zh-CN.msi) |
...
| 插件 | 版本 | 说明 | 版本历史 | 下载 |
|------|------|------|----------|------|
| ai-translator | 1.0.1 | [说明](plugins/ai-translator/) | [版本历史](plugins/ai-translator/CHANGELOG.md) | [下载](https://github.com/liTL0203/my-desktop-tools/releases/download/ai-translator-v1.0.1/ai-translator-1.0.1.zip) |
