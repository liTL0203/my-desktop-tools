...
- 电源键 / 休眠按钮不受影响
- 锁定范围与解锁手势可在控制窗「防护设置」中调整，设置保存在本地（`plugin-data/input-lock/`），不上传任何数据
...
1. Before cleaning, open "Input Lock" in the main window or Quick Launcher
